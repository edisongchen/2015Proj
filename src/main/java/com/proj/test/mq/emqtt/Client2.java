...
public class Client2 {
	 private final static String CONNECTION_STRING = "tcp://192.168.10.135:1883";    
	    ...
	    private final static String CLIENT_ID = "client2"; //唯一性标识，不可重复   
...
//	        new Topic("mqtt/bbb", QoS.AT_LEAST_ONCE),  // 1 至少一次  
	        ...
	        new Topic("$SYS/brokers/135@192.168.10.135/clients/", QoS.AT_MOST_ONCE),
	        new Topic("$SYS/brokers/135@192.168.10.135/stats", QoS.AT_MOST_ONCE)
	    };  
