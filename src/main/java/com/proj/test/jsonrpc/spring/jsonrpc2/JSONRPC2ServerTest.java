...
public class JSONRPC2ServerTest {
	...
	//since 1.4 dispatcher is able to report processing time in millisecond precision
	dispatcher.reportProcTime(true);
	...
	req = new JSONRPC2Request("getTime2", "req-id-03");
	System.out.println("Request: \n" + req);
